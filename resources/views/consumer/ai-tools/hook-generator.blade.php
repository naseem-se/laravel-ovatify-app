...
@section('content')
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-2xl font-bold text-accent">Hook Generator</h1>
    </div>
    ...
    {{-- Select Mood --}}
    <div class="mb-6">
        <label class="block text-sm font-medium mb-3">Select Mood</label>
        <select
    ...
    {{-- Hook Style --}}
    <div class="mb-8">
        <label class="block text-sm font-medium mb-3">Hook Style</label>
        <div class="flex flex-wrap gap-3">
            @foreach(['R&B Style' => true, 'Pop Hook' => false, 'Club Banger' => false, 'Chill' => false] as $style => $active)
                <button
